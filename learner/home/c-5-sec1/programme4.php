...
<div class="container mt-sm-5 my-5 carda ">
    <div class='row '>
    <div class="question d-inline-block  col-6 pt-2">
        <div class="py-2 h5 exercise" call_type='exercise3'  ><b>Exercise 3</b></div>
    ...
    <div class="d-flex align-items-center pt-3">
        <div id="prev mx-4">
            <button class="btn btn-primary" ><a class='link' href='programme3.php'>Previous</a></button>
        </div>
